...
## Limitations:
* There is no file dialog. it will load "X:\Project\Path\Assets\scene.gnsscene". Save will overwrite the file.
...
* Raytracing
* Save and Load improvements (a file dialogue would be cool)
* Multithreading
* Physics
* Scene picking
